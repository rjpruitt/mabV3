...
import { testCollectionService, testEmailService } from '@/lib/services/test-service-provider'

export default function TestNotificationsStandalonePage() {
  ...
  async function refreshNotifications() {
    const data = await testEmailService.getNotifications()
