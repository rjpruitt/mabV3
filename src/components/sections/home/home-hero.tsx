      ...
      <div className="container relative h-full mx-auto px-4">
        <div className="flex flex-col justify-center h-full max-w-2xl">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <Link
              href="/consultation"
              className="bg-accent px-8 py-3 rounded-sm inline-block font-montserrat font-semibold text-white hover:opacity-90 transition-opacity text-center"
            >
              BOOK A FREE CONSULTATION
            </Link>
            <Link
              href="/gallery"
              className="bg-transparent whitespace-nowrap border-2 border-white text-white px-8 py-3 rounded-sm font-montserrat font-semibold hover:bg-white/10 transition-all text-center"
            >
