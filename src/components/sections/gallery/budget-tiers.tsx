...
export function BudgetTiers(): React.JSX.Element {
  return (
    <Section 
      ...
      titleClassName="font-pt-serif text-4xl text-[#2F2F2F] mb-4 text-center"
      description="We offer a range of options to fit your style, timeline, and budget. Every solution includes our quality guarantee and professional installation."
      descriptionClassName="text-gray-600 text-center max-w-3xl mx-auto mb-16"
      ariaLabel="Budget tier options"
    >
      <div 
