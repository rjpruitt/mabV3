...
export function ContactForm({ 
  ...
  const toggleContactMethod = (method: string) => {
    ...
    handleChange('preferredContact', newMethods[0] as 'phone' | 'email' | 'text')
  }
  ...
  }, [formData.name, formData.email, formData.phone, formData.preferredContact])
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-gray-600 mt-2">
          We respect your privacy and will only use your information to schedule and confirm your safety assessment. No salespeople or telemarketers will contact you.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-gray-600">Select your preferred method</p>
